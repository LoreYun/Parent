...
- (void)viewDidLoad {
    ...
    UIImageView *logoIv  = [[UIImageView alloc] initWithImage:[UtilManager imageNamed:@"logo1"]];
...
//    [self.view addSubview:view];
    ...
    UIView *cell1 = [self createCell:@"检查更新" startY:20 action:@selector(checkVersion:)];
...
-(void)checkVersion:(id)sender
{
    ...
    [[ObjectManager sharedInstance] requestDataOnGet:@{@"1":@"ios",@"2":@"parent"} ByFlag:@"2901" callback:^(BOOL succeed, NSDictionary * data) {
        [self hideHud];
        if (succeed) {
