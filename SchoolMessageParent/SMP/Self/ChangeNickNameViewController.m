...
-(void)change:(id)sender
{
    ...
    [[ObjectManager sharedInstance] requestDataOnPost:@{@"1":[[AccountManager sharedInstance].LoginInfos getParentsId],@"2":nick} ByFlag:@"2702" callback:^(BOOL succed, NSDictionary *data) {
        if (succed) {
