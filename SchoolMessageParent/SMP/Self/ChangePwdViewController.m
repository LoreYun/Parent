...
-(void)change:(id)sender
{
    ...
    NSString *old = [[UtilManager md5:[NSString stringWithFormat:@"%@%@",[self.currentPwd.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]],PWDSTRING]] uppercaseString];//[[UtilManager md5:[self.currentPwd.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]]] uppercaseString];
    NSString *new = [[UtilManager md5:[NSString stringWithFormat:@"%@%@",[self.Passwords.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]],PWDSTRING]] uppercaseString];//[[UtilManager md5:[self.Passwords.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]]] uppercaseString];
    [[ObjectManager sharedInstance] requestDataOnPost:@{@"1":[[AccountManager sharedInstance].LoginInfos getParentsId],@"2":old,@"3":new} ByFlag:@"2701" callback:^(BOOL succeed, NSDictionary *data) {
        [self hideHud];
        if (succeed) {
