...
-(void)requestDataOnPost:(NSDictionary *)data ByFlag:(NSString *)flag callback:(void (^)(BOOL, NSDictionary *))callback
{
    ...
    NSDictionary *parameters = @{@"b":bparam,@"f":fparam,@"t":time,@"flag":@"parent"};//,@"c":cparam};
...
-(void)requestDataOnGet:(NSDictionary *)data ByFlag:(NSString *)flag callback:(void (^)(BOOL, NSDictionary *))callback
{
    ...
    NSString *bparam = [self Encode2B:data time:time flag:flag];
    NSString *fparam = [self Encode2F:data time:time flag:flag];
    NSDictionary *parameters = @{@"b":bparam,@"f":fparam,@"t":time,@"flag":@"parent"};
...
//    NSString *fparam = [self Encode2F:dic time:time flag:@"0"];
    NSDictionary *parameters = @{@"b":bparam,@"flag":@"parent"};//,@"c":cparam};
    //    NSLog(@"result b %@  c %@",bparam,cparam);
...
//    NSURL *url = [NSURL URLWithString:uploadImageUrl];
    [self uploadImage2Server:data url:[NSString stringWithFormat:@"%@UploadFile.ashx",uploadImageUrl] callback:callback];
...
-(void)uploadUserImage2Server:(NSData *)data callback:(void (^)(BOOL, NSDictionary *))callback
{
