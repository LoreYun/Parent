...
-(void)refreshTimeData:(id)sender
{
    ...
    NSDictionary * dic = @{@"1":[[AccountManager sharedInstance].LoginInfos getClassId]};
    
    [[ObjectManager sharedInstance] requestDataOnPost:dic ByFlag:@"2801" callback:^(BOOL succeed, NSDictionary *data) {
        [self hideHud];
        if (succeed) {
