...
#if DEBUG
    apnsCertName = @"whwy2015";
#else
    apnsCertName = @"whwy2015";
#endif
    
    [[EaseMob sharedInstance] registerSDKWithAppKey:@"199010#schoolmailtunnels"
...
//    [[[UIAlertView alloc] initWithTitle:_deviceToken message:_deviceToken delegate:nil cancelButtonTitle:@"ddd" otherButtonTitles:@"ss", nil] show];
//    
                               ...
                               error:(EMError *)error
{
    ...
    NSString *message = [NSString stringWithFormat:@"同意并已加入群组\'%@\'", groupTag];
