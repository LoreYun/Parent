...
@interface HomeWrokAddViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,ClassChooseAlertViewDalegate,UITextViewDelegate,PhotoSelectedAlertViewDalegate,DoImagePickerControllerDelegate>
...
-(void)viewDidLoad
{
    ...
    self.subjectLabel = [self createChooseView:@selector(alertSubject:) title:@"科目" content:@"" startY:20];
    self.classNameLabel = [self createChooseView:@selector(alertClass:) title:@"年纪" content:@"" startY:75];
...
-(void)initTitle
{
    ...
    self.titleField = [[UITextView alloc] initWithFrame:CGRectMake(101.5, 1, SCREEN_WIDTH-16-101.5, 39)];
...
-(void)initContent
{
    ...
    self.contentField = [[UITextView alloc] initWithFrame:CGRectMake(101.5, 1, SCREEN_WIDTH-16-101.5, 106.5)];
