...
-(void)viewDidLoad
{
    ...
    self.title = [NSString stringWithFormat:@"欢迎：%@",[[AccountManager sharedInstance].LoginInfos getStudentName]];
    [self createMain];
    [self createDoc];
}
...
//    [flowLayout setScrollDirection:UICollectionViewScrollDirectionVertical];
    ...
    self.iconArray = @[@"gonggao",@"dianping",@"tongxunlu",@"xiangce",@"tongzhi",@"xuexi",@"jiaoyu",@"zuoye",@"kaoqin"];
    self.iconTextArray =@[@"校园公告",@"学生点评",@"通讯录",@"班级相册",@"班级通知",@"学习",@"津城教育",@"作业",@"考勤"];
