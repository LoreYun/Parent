...
- (void)viewDidLoad {
    ...
    UIView *cell1 = [self createCell:@"chengjichaxun" title:@"成绩查询" startY:0.5 action:@selector(push2Timetable:)];
    
    [self.view addSubview:cell1];
    
    UIView *cell2 = [self createCell:@"kebiao" title:@"课表" startY:51.5 action:@selector(push2Homework:)];
...
{
    QueryResultController *set = [[QueryResultController alloc] init];
    [self.navigationController pushViewController:set animated:YES];
}
