...
//    [self.view addSubview:button];
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(10, 10, SCREEN_WIDTH-20, SCREEN_HEIGHT-64-20) collectionViewLayout:flowLayout];
...
-(void)creatRefreshFooder:(UIScrollView *)scr
{
    ...
    fooder.scrollView = self.collectionView;
    fooder_ = fooder;
}
