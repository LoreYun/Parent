...
-(void)viewDidLoad
{
    ...
    self.inputView = [[UITextView alloc] initWithFrame:CGRectMake(8, 116, SCREEN_WIDTH-16,120)];
...
{
    ClassChooseAlertView * alert = [[ClassChooseAlertView alloc] initWithDic:[[AccountManager sharedInstance].LoginInfos getTeacherSubject] classID:self.SubjectId type:SujectChoose];
    alert.delegate = self;
    [alert show];
}
