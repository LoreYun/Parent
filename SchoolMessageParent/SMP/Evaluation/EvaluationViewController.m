...
//    XueHao = 2001;
    ...
    self.tableview = [[UITableView alloc] initWithFrame:CGRectMake(16, 0, SCREEN_WIDTH-32, SCREEN_HEIGHT-64)];
...
-(void)getSutdentInfos
{
    ...
    [[ObjectManager sharedInstance] requestDataOnPost:@{@"1":studentid,@"2":@"1",@"3":@"150",@"4":@"0"} ByFlag:@"21101" callback:^(BOOL succeed, NSDictionary *data) {
        [self hideHud];
        if (succeed) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        UILabel * title = [[UILabel alloc] initWithFrame:CGRectMake(10, 14, 85, 19)];
        ...
        UILabel * time = [[UILabel alloc] initWithFrame:CGRectMake(100, 14, SCREEN_WIDTH-32-169-20, 19)];
        ...
        UILabel * content = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-32-69-20, 14,79, 19)];
        ...
        UIView *div = [[UIView alloc] initWithFrame:CGRectMake(0, 34.5, SCREEN_WIDTH-32, 0.5)];
    ...
    UILabel * timecontent = (UILabel *)[cell viewWithTag:2];
    UILabel * content = (UILabel *)[cell viewWithTag:3];
    NSDictionary * dic = [self.mainData objectAtIndex:indexPath.row];
    
    
    title.text = [dic objectForKey:@"TeacherName"];
    NSString *time = [dic objectForKey:@"CommentTime"];
    timecontent.text = [[time componentsSeparatedByString:@" "] objectAtIndex:0];
