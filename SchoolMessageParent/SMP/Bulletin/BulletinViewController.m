...
{
    NSDictionary *dic = @{@"1":@"5",@"2":[[AccountManager sharedInstance].LoginInfos getParentsId],@"3":[[AccountManager sharedInstance].LoginInfos getAccount],@"4":@"10",@"5":[NSString stringWithFormat:@"%ld",(long)self.page]};
    [[ObjectManager sharedInstance] requestDataOnPost:dic ByFlag:@"24021" callback:callback];
}
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *content = [dic objectForKey:@"GaiYao"];
